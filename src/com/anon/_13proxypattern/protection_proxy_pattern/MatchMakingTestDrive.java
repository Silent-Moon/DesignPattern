...
public class MatchMakingTestDrive {
    private Hashtable<String, PersonBean> datingDB;

    public MatchMakingTestDrive() {
        datingDB = new Hashtable<>();
        initializeDatabase();
    }
    ...
    public void drive() {
        ...
        System.out.println("Invoked through proxy class: " + Proxy.isProxyClass(ownerProxy.getClass()));
